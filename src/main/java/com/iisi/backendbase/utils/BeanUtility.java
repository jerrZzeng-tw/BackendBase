...
public class BeanUtility {
    ...
    public static <T> T clone(T t) {
        try {
            return (T) BeanUtilsBean2.getInstance().cloneBean(t);
    ...
    public static Object getBeanProperty(Object bean, String propertyName) {
        try {
            ...
            if (log.isDebugEnabled()) {
                log.debug("執行 BeanUtility.getBeanProperty() 失敗 Bean Class: {} Property Name: {}", bean.getClass().getName(), propertyName);
            }
            return null;
        }
    }
    ...
    public static void setBeanProperty(Object bean, String propertyName, Object value) {
        try {
            ...
            if (log.isDebugEnabled()) {
                log.debug("執行 BeanUtility.setBeanProperty() 失敗 Bean Class: {} Property Name: {}", bean.getClass().getName(), propertyName);
            }
        }
    }
    ...
    public static void copyPropertiesNonNull(Object dest, Object orig) {
        try {
            ...
            if (log.isDebugEnabled()) {
                log.debug("BeanUtility.copyPropertiesNonNull() 複製資料時發生錯誤: from {} to {}", orig.getClass().getName(),
     ...
     * @throws InvocationTargetException
     */
    public static void replacePropertiesWithoutNull(Object obj) throws IllegalAccessException, InvocationTargetException {
        if (obj == null) {
            throw new IllegalArgumentException("No origin bean specified");
        }
                ...
                try {
                    ...
                    if (value == null) {
                        if (objDescriptors[i].getPropertyType().getName().equals("java.lang.String")) {
                            ...
                            value = 0;
                        } else if (objDescriptors[i].getPropertyType().getName().equals("java.lang.Short")) {
                            value = (short) 0;
                        }
                    }
    ...
    public static void copyPropertiesForUpdate(Object dest, Object orig, String oldFieldPrefix) {
        try {
            ...
            if (log.isDebugEnabled()) {
                log.debug("BeanUtility.copyPropertiesForUpdate() 複製資料時發生錯誤: from {} to {}", orig.getClass().getName(),
                        dest.getClass().getName());
            }
        }
    }
     ...
     * @throws Exception
     */
    public static <T> T jsaonToObject(String json, Class<T> targetClass) throws Exception {
